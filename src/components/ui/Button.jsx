...
const VARIANTS = {
  ...
  danger:
    "bg-error text-on-error hover:bg-[#a01515] disabled:opacity-50",

  ghost:
    "bg-transparent text-primary hover:bg-primary-container/10 disabled:opacity-50",
};
...
const SIZES = {
  ...
  md:
    "h-12 px-5 text-sm gap-2",

  lg:
    "h-14 px-6 text-base gap-2",
};
